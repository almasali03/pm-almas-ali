    ...
    <div className={`w-full min-h-full font-sans ${theme === "dark" ? "dark" : ""}`}>
      <div className="w-full min-h-full bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 transition-colors duration-300">
        ...
        <section 
          ref={skillsRef} 
          id="skills" 
          className="py-16 md:py-24 px-4 bg-gray-50 dark:bg-gray-800 transition-colors duration-300"
        >
          <div className="container mx-auto">
            <div className="text-center mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {skills.map((skillGroup, index) => (
                <div 
                  key={index} 
                  className="bg-white dark:bg-gray-900 rounded-lg shadow-md p-6 transition-all duration-300 hover:shadow-lg"
                >
                  <h3 className="text-lg font-bold mb-4 text-gray-900 dark:text-white" style={{ color: themeStyles.accentColor }}>
                    {skillGroup.category}
                  </h3>
                  <div className="space-y-2">
                    {skillGroup.items.map((skill, i) => (
                      <div key={i} className="text-sm text-gray-600 dark:text-gray-300 py-1 px-2 bg-gray-100 dark:bg-gray-800 rounded">
                        {skill}
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="pt-6 border-t border-gray-200 dark:border-gray-700">
                      ...
                      <div className="flex space-x-4">
                        <a href="https://www.linkedin.com/in/almasali03/" className="p-3 rounded-full transition-colors" style={{ backgroundColor: `${themeStyles.accentColor}20` }}>
                          <Linkedin size={20} style={{ color: themeStyles.accentColor }} />
                        </a>
                        <a href="https://github.com/almasali03" className="p-3 rounded-full transition-colors" style={{ backgroundColor: `${themeStyles.accentColor}20` }}>
                          <Github size={20} style={{ color: themeStyles.accentColor }} />
                        </a>
                        <a href="mailto:almasali03@gmail.com" className="p-3 rounded-full transition-colors" style={{ backgroundColor: `${themeStyles.accentColor}20` }}>
                          <Mail size={20} style={{ color: themeStyles.accentColor }} />
                        </a>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {selectedProject.impact.map((item: string, i: number) => (
                          <div key={i} className="flex items-center">
                            <CheckCircle size={16} className="mr-2 flex-shrink-0" style={{ color: themeStyles.accentColor }} />
