...
export default function Portfolio({
  ...
  profileImage = "https://drive.google.com/uc?export=view&id=1k5o_JGpJJu2Xw1nMUvgvpEfcrl62y7Sh",
  primaryColor = "#4f46e5",
  darkMode = false
}) {
  // State hooks
  ...
  const projects = [
    {
      ...
      impact: [
        "500K+ app downloads on Google Playstore",
        "60,000+ loans facilitated",
        "3rd largest P2P company in India by 2019",
    ...
    },
    {
      ...
      impact: [
        "$2.4M revenue in first quarter",
        "30-50 days working capital extension",
        "Industry-first innovation",
        "3 bank partnerships for scale"
      ],
    ...
    },
    {
      ...
      impact: [
        "20% increase in KYC completion rates",
        "Reduced manual rejections",
        "Improved user onboarding experience",
        "Decreased drop-off rate from 60%"
      ],
  ...
  const achievements = [
    "Scaled India's top-rated lending app to 500K+ downloads and USD 30M+ in disbursement volume",
    "Launched FinTech products in 4 APAC markets, cutting launch time by 67%",
    "Innovated industry-first in-app Tax Receipts Payments solutions, leading to $2.4Mn Q1 revenue",
    "Increased app rating from 3.7 to 4.3 and cut crash rate by 45%",
    "Lifted onboarding funnel conversions by 20% and KYC approvals by 10%"
  ];
  ...
  const experience = [
    {
      ...
      location: "Remote",
      description: [
        "Led FinTech product launches across 4 APAC regions, cutting GTM time by 67%",
        "Expanded product suite with cross-border payments, rent collections/payments, tax modules",
        "Led ERP integrations (SAP Taulia, Oracle), unlocking enterprise accounts",
        "Revamped 5+ regional web/mobile applications using Agile framework"
      ]
    },
    {
      ...
      location: "Remote",
      description: [
        "Reduced OTP and bank verification failures by 60% via fallback vendor systems",
        "Improved KYC funnel by 20%, registration by 6%, and card flow by 4%",
        "Led UAE, Singapore, and Australia rollouts with strong compliance",
        "Built automated MIS for real-time reports, saving 15% manual reporting hours"
      ]
    },
    {
      ...
      location: "Mumbai",
      description: [
        "Launched MVP app for India and UAE, driving 300K+ SME registrations in first year",
        "Conceptualized & launched industry-first in-app GST payments, unlocking new revenue streams",
        "Co-created 'Sherlock' fraud engine with AI/ML-based behavioral analytics",
        "Improved PAN KYC approvals by 10%, boosting conversion rates"
      ]
    },
    {
      ...
      description: [
        ...
        "Built MVP, owned product roadmap, UI, and user growth channels",
        "Managed compliance, NBFC partnerships, and technology vendor onboarding"
      ]
    }
  ];
  ...
  return (
    <div className={`w-full min-h-full font-sans ${theme === "dark" ? "dark" : ""}`}>
      <div className="w-full min-h-full bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 transition-colors duration-300">
        ...
        <nav className="fixed top-0 left-0 right-0 z-50 bg-white dark:bg-gray-900 shadow-md transition-colors duration-300">
          <div className="container mx-auto px-4 py-3 flex justify-between items-center">
            <a href="#" className="text-xl font-bold" style={{ color: themeStyles.accentColor }}>
            ...
            <div className="hidden md:flex space-x-8">
              {sections.map((section) => (
                <button
                  ...
                  style={activeSection === section ? { color: themeStyles.accentColor } : {}}
                >
                  {section}
                </button>
              ))}
              ...
              <div className="container mx-auto px-4 py-2 flex flex-col space-y-3">
                {sections.map((section) => (
                  <button
                    key={section}
                    onClick={() => scrollToSection(section)}
                    className={`py-2 capitalize transition-colors duration-300 ${
                      activeSection === section
                        ? `font-medium`
        ...
        >
          <div className="container mx-auto flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0">
              <div>
                <p className="text-sm md:text-base uppercase tracking-wider mb-2" style={{ color: themeStyles.accentColor }}>
                  Hello, I'm
                </p>
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  <button 
                    ...
                    className="px-6 py-3 rounded-md font-medium border-2 transition-all duration-300 text-gray-800 dark:text-white border-gray-300 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800"
                  >
                    Contact Me
                  </button>
                </div>
            ...
            <div className="md:w-1/2 flex justify-center">
              <div className="relative">
                ...
                <div 
                  className="absolute -bottom-4 -right-4 w-24 h-24 rounded-full flex items-center justify-center text-white text-xl font-bold shadow-lg"
        ...
        <section 
          ref={aboutRef} 
          id="about" 
          className="py-16 md:py-24 px-4 bg-white dark:bg-gray-900 transition-colors duration-300"
        >
          <div className="container mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900 dark:text-white">About Me</h2>
              <div className="w-24 h-1 mx-auto rounded" style={{ backgroundColor: themeStyles.accentColor }}></div>
            </div>
                  ...
                  <div className="space-y-3">
                    {achievements.map((achievement, index) => (
                      <div key={index} className="flex items-start">
                        <CheckCircle className="flex-shrink-0 mt-1 mr-2" size={16} style={{ color: themeStyles.accentColor }} />
                ...
                <div className="mb-10">
                  ...
                  <div className="flex flex-col gap-6">
                    {strengths.map((strength, index) => {
                      ...
                      return (
                        <div key={index} className="bg-white dark:bg-gray-800 p-5 rounded-lg shadow-md flex items-start">
                          <IconComp
                            size={24}
                      ...
                      <ul className="space-y-2">
                        {job.description.map((point, i) => (
                          <li key={i} className="flex items-start">
                            <ChevronRight size={16} className="mt-1 mr-2" style={{ color: themeStyles.accentColor }} />
        ...
        <section 
          ref={skillsRef} 
          id="skills" 
          className="py-16 md:py-24 px-4 bg-gray-50 dark:bg-gray-800"
        >
          <div className="container mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                With over 8 years in Product Management, I've developed a diverse skill set across product strategy, leadership, and technical domains.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {skills.map((skillCategory, index) => (
                ...
                >
                  <h3 className="text-lg font-bold mb-4 pb-2 border-b border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white" 
                     style={{ color: themeStyles.accentColor }}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md flex flex-col items-center">
                  <div className="w-16 h-16 flex items-center justify-center rounded-full mb-4"
                    ...
                    <Award size={32} style={{ color: themeStyles.accentColor }} />
                  </div>
                ...
                <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md flex flex-col items-center">
                  <div className="w-16 h-16 flex items-center justify-center rounded-full mb-4"
                       style={{ backgroundColor: `${themeStyles.accentColor}20` }}>
                    <TrendingUp size={32} style={{ color: themeStyles.accentColor }} />
                  </div>
                ...
                <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md flex flex-col items-center">
                  <div className="w-16 h-16 flex items-center justify-center rounded-full mb-4"
                       style={{ backgroundColor: `${themeStyles.accentColor}20` }}>
                    <svg className="w-8 h-8" style={{ color: themeStyles.accentColor }} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        {project.impact.map((item, i) => (
                          <div key={i} className="flex items-start">
                            <CheckCircle size={14} className="mt-0.5 mr-1 flex-shrink-0" style={{ color: themeStyles.accentColor }} />
            ...
            <div className="mt-16 bg-white dark:bg-gray-800 rounded-lg p-8 shadow-md">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-start">
                  <div className="p-3 rounded-full mr-4" style={{ backgroundColor: `${themeStyles.accentColor}20` }}>
                    <svg className="w-6 h-6" style={{ color: themeStyles.accentColor }} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        ...
        >
          <div className="container mx-auto">
            <div className="text-center mb-12">
              ...
              <div className="w-24 h-1 mx-auto rounded" style={{ backgroundColor: themeStyles.accentColor }}></div>
              <p className="mt-4 text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                Interested in discussing product strategy, FinTech innovations, or potential opportunities? Feel free to reach out!
              </p>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-8">
              <div className="md:w-1/2">
                <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md p-6">
                  ...
                  <div>
                    ...
                    <button 
                      type="button" 
                      className="w-full px-6 py-3 rounded-md font-medium transition-all duration-300 text-white"
                      style={{ backgroundColor: themeStyles.accentColor }}
                    >
                      Send Message
                    </button>
              ...
              <div className="md:w-1/2">
                <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md p-6 h-full">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      <div className="flex-shrink-0 p-3 rounded-full" style={{ backgroundColor: `${themeStyles.accentColor}20` }}>
                        <Mail size={24} style={{ color: themeStyles.accentColor }} />
                      </div>
                      <div className="ml-4">
                    ...
                    <div className="flex items-start">
                      <div className="flex-shrink-0 p-3 rounded-full" style={{ backgroundColor: `${themeStyles.accentColor}20` }}>
                        <Phone size={24} style={{ color: themeStyles.accentColor }} />
                      </div>
                      <div className="ml-4">
                        <h4 className="text-base font-medium text-gray-900 dark:text-white">WhatsApp</h4>
                        <a href="https://wa.me/919677136490" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">
                          +91 9677136490
                        </a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      <div className="flex-shrink-0 p-3 rounded-full" style={{ backgroundColor: `${themeStyles.accentColor}20` }}>
                        <MapPin size={24} style={{ color: themeStyles.accentColor }} />
                      </div>
                      <div className="ml-4">
                  ...
                  <div className="mt-8">
                    ...
                    <div className="flex space-x-4">
                      <a 
                        href="https://github.com/almasali03" 
                        target="_blank" 
                        rel="noopener noreferrer" 
                        className="p-3 rounded-full transition-colors duration-300"
                        style={{ backgroundColor: `${themeStyles.accentColor}20` }}
                      >
                        <Github size={20} style={{ color: themeStyles.accentColor }} />
                      </a>
                      <a 
                        href="https://www.linkedin.com/in/alialmas/" 
                        target="_blank" 
                        rel="noopener noreferrer" 
                        className="p-3 rounded-full transition-colors duration-300"
                        style={{ backgroundColor: `${themeStyles.accentColor}20` }}
                      >
                        <Linkedin size={20} style={{ color: themeStyles.accentColor }} />
                      </a>
                    </div>
                  </div>
                </div>
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="mb-4 md:mb-0">
                <a href="#" className="text-xl font-bold" style={{ color: themeStyles.accentColor }}>
                  {name.split(" ")[0]}<span className="text-white">Ali</span>
                </a>
              ...
              <div className="flex flex-wrap justify-center gap-4">
                {sections.map((section) => (
                  <button
                    key={section}
                    onClick={() => scrollToSection(section)}
                    className="capitalize text-gray-400 hover:text-white transition-colors duration-300"
                  >
                    {section}
                  </button>
                ))}
            ...
            <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
              ...
              <p className="text-sm text-gray-400 mt-2 md:mt-0">
                Product Manager | FinTech Expert | Agile Leader
              </p>
            </div>
          </div>
        </footer>
        ...
        <AnimatePresence>
          {isModalOpen && selectedProject && (
            ...
            >
              ...
              <motion.div
                key="panel"
                className="relative bg-white dark:bg-gray-900 rounded-lg text-left overflow-hidden shadow-xl sm:my-8 sm:align-middle sm:max-w-3xl w-full mx-4"
                ...
                <div className="px-6 pt-5 pb-8">
                  <div className="sm:flex sm:items-start">
                    <div className="mt-3 text-center sm:mt-0 sm:text-left w-full">
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">{selectedProject.subtitle}</p>
                      ...
                      <div className="mt-6">
                        ...
                        <div className="mt-8 space-y-6">
                          <div>
                            ...
                            <p className="text-gray-700 dark:text-gray-300">{selectedProject.problem}</p>
                          </div>
                          
                          <div>
                            <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">My Contributions</h4>
                            <p className="text-gray-700 dark:text-gray-300">{selectedProject.contributions}</p>
                          </div>
                          ...
                          <div>
                            <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Technologies & Skills</h4>
                            <div className="flex flex-wrap gap-2">
